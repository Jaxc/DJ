...
proc create_root_design { parentCell } {
  ...
  set BCLK_1 [ create_bd_port -dir O -type clk BCLK_1 ]
  set MCLK [ create_bd_port -dir O -type clk MCLK ]
  set MCLK_1 [ create_bd_port -dir O -type clk MCLK_1 ]
  set MUTE [ create_bd_port -dir O MUTE ]
  set MUTE_1 [ create_bd_port -dir O MUTE_1 ]
  set PBDAT [ create_bd_port -dir O -type data PBDAT ]
  set PBDAT_1 [ create_bd_port -dir O -type data PBDAT_1 ]
  set PBLRC [ create_bd_port -dir O -type clk PBLRC ]
  set PBLRC_1 [ create_bd_port -dir O -type clk PBLRC_1 ]

  # Create instance: Jaxc_I2S_0, and set properties
  set Jaxc_I2S_0 [ create_bd_cell -type ip -vlnv Jaxcie.com:Audio:Jaxc_I2S:1.8.1 Jaxc_I2S_0 ]

  set_property -dict [ list \
CONFIG.NUM_READ_OUTSTANDING {1} \
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /Jaxc_I2S_0/s_axi]
...
CONFIG.PCW_IMPORT_BOARD_PRESET {/home/jaxc/FPGA/DJ-Jaxc/ZYBO_zynq_def.xml} \
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins Jaxc_I2S_0/s_axi] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net Jaxc_I2S_0_BCLK [get_bd_ports BCLK] [get_bd_ports BCLK_1] [get_bd_pins Jaxc_I2S_0/BCLK]
  connect_bd_net -net Jaxc_I2S_0_MCLK [get_bd_ports MCLK] [get_bd_ports MCLK_1] [get_bd_pins Jaxc_I2S_0/MCLK]
  connect_bd_net -net Jaxc_I2S_0_MUTE [get_bd_ports MUTE] [get_bd_ports MUTE_1] [get_bd_pins Jaxc_I2S_0/MUTE]
  connect_bd_net -net Jaxc_I2S_0_PBDAT [get_bd_ports PBDAT] [get_bd_ports PBDAT_1] [get_bd_pins Jaxc_I2S_0/PBDAT]
  connect_bd_net -net Jaxc_I2S_0_PBLRC [get_bd_ports PBLRC] [get_bd_ports PBLRC_1] [get_bd_pins Jaxc_I2S_0/PBLRC]
  connect_bd_net -net Jaxc_I2S_0_int_out [get_bd_pins Jaxc_I2S_0/int_out] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Jaxc_I2S_0/CLK_100M] [get_bd_pins Jaxc_I2S_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins Jaxc_I2S_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Jaxc_I2S_0/s_axi/reg0] SEG_Jaxc_I2S_0_reg0

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   guistr: "# # String gsaved with Nlview 6.6.5b  2016-09-06 bk=1.3687 VDI=39 GEI=35 GUI=JA:1.6
#  -string -flagsOSRD
preplace port PBDAT -pg 1 -y 100 -defaultsOSRD
preplace port DDR -pg 1 -y 250 -defaultsOSRD
preplace port MCLK -pg 1 -y 180 -defaultsOSRD
preplace port BCLK_1 -pg 1 -y 20 -defaultsOSRD
preplace port BCLK -pg 1 -y 120 -defaultsOSRD
preplace port PBDAT_1 -pg 1 -y 0 -defaultsOSRD
preplace port PBLRC -pg 1 -y 140 -defaultsOSRD
preplace port IIC_0 -pg 1 -y 290 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 270 -defaultsOSRD
preplace port MUTE_1 -pg 1 -y 60 -defaultsOSRD
preplace port PBLRC_1 -pg 1 -y 40 -defaultsOSRD
preplace port MCLK_1 -pg 1 -y 80 -defaultsOSRD
preplace port MUTE -pg 1 -y 160 -defaultsOSRD
preplace inst Jaxc_I2S_0 -pg 1 -lvl 3 -y 150 -defaultsOSRD
...
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 410 -10 730J
preplace netloc Jaxc_I2S_0_BCLK 1 3 1 950
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 0 20 390
preplace netloc processing_system7_0_IIC_0 1 1 3 N 290 NJ 290 NJ
preplace netloc Jaxc_I2S_0_MCLK 1 3 1 980
preplace netloc Jaxc_I2S_0_PBLRC 1 3 1 960
preplace netloc Jaxc_I2S_0_PBDAT 1 3 1 940
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 270 NJ 270 NJ
preplace netloc Jaxc_I2S_0_MUTE 1 3 1 970
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 -10 10 420 350 740J
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 720
preplace netloc Jaxc_I2S_0_int_out 1 0 4 0 200 410J 260 NJ 260 960
preplace netloc rst_ps7_0_100M_interconnect_aresetn 1 1 1 400
levelinfo -pg 1 -30 200 580 840 1010 -top -20 -bot 420
",
}
