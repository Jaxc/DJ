...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ADC_DATA_in [ create_bd_port -dir I -from 0 -to 0 -type data ADC_DATA_in ]
  set BCLK [ create_bd_port -dir O -from 0 -to 0 -type clk BCLK ]
  ...
  set PBDAT [ create_bd_port -dir O -from 0 -to 0 -type data PBDAT ]
  set PBLRC [ create_bd_port -dir O -from 0 -to 0 PBLRC ]
  ...
  set_property -dict [ list CONFIG.Division_factor {4}  ] $CLK_DIV_0
  ...
  set Jaxc_I2S_0 [ create_bd_cell -type ip -vlnv Jaxcie.com:Audio:Jaxc_I2S:1.7.0 Jaxc_I2S_0 ]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M03_AXI [get_bd_intf_pins Jaxc_I2S_0/s_axi] [get_bd_intf_pins processing_system7_0_axi_periph/M03_AXI]

  # Create port connections
  connect_bd_net -net CLK_DIV_0_CLK_out [get_bd_ports BCLK] [get_bd_pins CLK_DIV_0/CLK_out] [get_bd_pins CLK_DIV_1/CLK_in] [get_bd_pins CLK_test_0/CLK2] [get_bd_pins Jaxc_I2S_0/BCLK]
  connect_bd_net -net CLK_DIV_1_CLK_out [get_bd_ports PBLRC] [get_bd_pins CLK_DIV_1/CLK_out] [get_bd_pins Jaxc_I2S_0/PBLRC]
  connect_bd_net -net CLK_FPGA [get_bd_pins BTNs_4Bits/s_axi_aclk] [get_bd_pins Jaxc_I2S_0/s_axi_aclk] [get_bd_pins SWs_4Bits/s_axi_aclk] [get_bd_pins axi_protocol_converter_0/aclk] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/M01_ACLK] [get_bd_pins processing_system7_0_axi_periph/M02_ACLK] [get_bd_pins processing_system7_0_axi_periph/M03_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins xadc_wiz_0/s_axi_aclk]
  ...
  connect_bd_net -net Jaxc_I2S_0_int_out [get_bd_pins Jaxc_I2S_0/int_out] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_ports MCLK] [get_bd_pins CLK_DIV_0/CLK_in] [get_bd_pins CLK_test_0/CLK1] [get_bd_pins processing_system7_0/FCLK_CLK2]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]
  connect_bd_net -net processing_system7_0_FCLK_RESET2_N [get_bd_pins CLK_DIV_0/RSTN] [get_bd_pins CLK_DIV_1/RSTN] [get_bd_pins CLK_test_0/rstn] [get_bd_pins processing_system7_0/FCLK_RESET2_N]
  connect_bd_net -net rst_processing_system7_0_97M_peripheral_aresetn [get_bd_pins BTNs_4Bits/s_axi_aresetn] [get_bd_pins Jaxc_I2S_0/s_axi_aresetn] [get_bd_pins SWs_4Bits/s_axi_aresetn] [get_bd_pins axi_protocol_converter_0/aresetn] [get_bd_pins proc_sys_reset_0/interconnect_aresetn] [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M01_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M02_ARESETN] [get_bd_pins processing_system7_0_axi_periph/M03_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins xadc_wiz_0/s_axi_aresetn]
